...
static const char *fonts[] = {
    "Sans:size=11",
	"NanumGothic:size=11:weight=demibold",
    "WenQuanYi Micro Hei:size=11:weight=demibold",
};
...
static const unsigned int brdalpha  = 0xee;     /* alpha value of border */
...
/* tagging */
static const char *tags[] = { "1", "2", "3", "4", "5", "6", "7", "8", "9", "Z",  };
